...
import com.mylife.bean.ThingObj;
	...
	public void btonclik(View view) {
		...
		if (view.getId() == R.id.list_import) {
			...
			if(flag==1){
				...
				button.setBackgroundResource(R.drawable.commentni6);
	...
	private class DataAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(mypride==0){
				...
				cache.l_img.setImageResource(R.drawable.commentni6);
				...
				cache.l_img.setImageResource(R.drawable.commentni9);
			}
